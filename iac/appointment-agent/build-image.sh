...
IMAGE_NAME="appointment-agent"
DEFAULT_TAG="latest"
DOCKERFILE_PATH="../../agents/appointment_management_agent"
...
echo -e "${BLUE}=== Appointment Agent Docker Image Build ===${NC}"
...
echo -e "${YELLOW}Usage:${NC} docker run -p 8001:8000 $FULL_IMAGE_NAME"
echo ""
