...
SERVICE_NAME="rag-service-2"
IMAGE_NAME="rag-service-2"
DEFAULT_TAG="latest"
DOCKERFILE_PATH="../../agents/rag-service-2"
...
echo -e "${BLUE}=== RAG Service Docker Image Build ===${NC}"
...
echo -e "${YELLOW}Usage:${NC} docker run -p 8002:8000 $FULL_IMAGE_NAME"
echo ""
