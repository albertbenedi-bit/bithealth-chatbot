...
SERVICE_NAME="backend-orchestrator"
IMAGE_NAME="backend-orchestrator"
DEFAULT_TAG="latest"
DOCKERFILE_PATH="../../backend_orchestrator"
...
echo -e "${BLUE}=== Backend Orchestrator Docker Image Build ===${NC}"
...
echo -e "${YELLOW}Usage:${NC} docker run -p 8000:8000 $FULL_IMAGE_NAME"
echo ""
